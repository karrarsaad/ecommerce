...
return redirect()->route('admin.maincategories')->with(['success'=>'تم الحفظ بنجاح']);
    ...
    DB::rollBack();
    return redirect()->route('admin.maincategories')->with(['error'=>'تم يتم الحفظ']);
}
}

public function edit($mainCar_id){
     $mainCategory=MainCategory::with('categories')->selection()->find($mainCar_id);
    if(!$mainCategory){
