                                            ...
                                            @isset($categories)
                                                @foreach($categories as $category)
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><img style="width: 120px;height: 100px" src="{{$category->photo}}"></td>
                                                        {{--                                                <td>{{$language->active}}</td>--}}
                                                        {{--                                                <td>{{$language->getActive($language)}}</td>--}}
                                                        <td>
                                                            <div class="btn-group" role="group"
                                                                ...
                                                                <a href="{{route('admin.maincategories.status',$category->id)}}"
                                                                   class="btn btn-outline-cyan btn-min-width box-shadow-3 mr-1 mb-1">
